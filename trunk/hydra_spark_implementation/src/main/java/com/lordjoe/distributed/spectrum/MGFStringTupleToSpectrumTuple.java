 ...
 * Date: 9/24/2014
 */
public class MGFStringTupleToSpectrumTuple implements PairFunction<Tuple2<String, String>, String, IMeasuredSpectrum> {

    @Override
    public Tuple2<String, IMeasuredSpectrum> call(final Tuple2<String, String> kv) throws Exception {
