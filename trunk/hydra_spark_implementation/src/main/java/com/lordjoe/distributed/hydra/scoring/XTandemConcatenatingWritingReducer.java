...
/**
 * com.lordjoe.distributed.hydra.scoring.XTandemConcatenatingWritingReducer
 * User: Steve
 * Date: 10/6/2014
 */
public class XTandemConcatenatingWritingReducer  extends AbstractTandemFunction implements IReducerFunction<String, MultiScorer,String, MultiScorer> {
    public XTandemConcatenatingWritingReducer(XTandemMain app) {
        super(app);
    }
...
//            }
    ...
    @Nonnull
    @Override
    public void handleValues(@Nonnull final String key, @Nonnull final Iterable<MultiScorer> values, final IKeyValueConsumer<String, MultiScorer>... consumer) {
        throw new UnsupportedOperationException("Fix This"); // ToDo
    }

    //
//    protected void reduceNormal(final Text key, final Iterable<Text> values, final Reducer.Context context)
