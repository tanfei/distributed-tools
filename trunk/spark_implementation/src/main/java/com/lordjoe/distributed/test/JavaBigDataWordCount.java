 ...
 * then broken into String groups and all varients with different case are generated
...
public final class JavaBigDataWordCount {
    ...
    public static final String GETTYSBURG =
            "Four score and seven years ago our fathers brought forth, upon this continent, a new nation, conceived in liberty," +
                    ...
                    " and so dedicated, can long endure. We are met on a great battle field of that war. We come to dedicate a portion of it," +
                    ...
                    " we take increased devotion to that cause for which they here, gave the last full measure of devotion – that we here highly resolve" +
    ...
    public static void main(String[] args) throws Exception {
        ...
        // try for variant counts 10..32 by 2 - Each case is 4 times the size
